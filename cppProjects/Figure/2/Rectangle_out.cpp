...
std::string Rectangle_out(char* nums, int size, const std::string& name); 
...
int main() {
    ...
    std::thread thread(Rectangle_out, strings, size, figure);
    thread.detach();
    ...
    std::cout  << Rectangle_out(strings, size, figure);
