...
namespace IPO8381 {
    ...
    public:
        ...
        bool is_matrix_square(const Matrix& rhs) const;
        bool is_matrix_diagonal(const Matrix& rhs) const;
        bool is_matrix_upper_triangular(const Matrix& rhs) const;
        bool is_matrix_lower_triangular(const Matrix& rhs) const;
        bool is_matrix_reversible(const Matrix& rhs) const;
        
        void matrix_conversion (const Matrix& rhs) const; 
        void calculate_determinator_matrix(const Matrix& rhs) const;
        void calculate_matrix_transposition(const Matrix& rhs) const;
